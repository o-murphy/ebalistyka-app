...
## ФАЗА 3 — RecalcCoordinator (прибрати ефект доміно) ✅ COMPLETED & REMOVED
...
7. ФАЗА 3 — RecalcCoordinator — DONE & REMOVED ✅
   a) Створити lib/providers/recalc_coordinator.dart — ✅ DONE (later REMOVED)
   b) Оновити router.dart — ✅ DONE (remove coordinator calls)
   c) Видалити ref.listen з _ScaffoldWithNavState — ✅ DONE
   d) Рефакторинг: перенести слухачів в кожний ViewModel — ✅ DONE (April 2026)
